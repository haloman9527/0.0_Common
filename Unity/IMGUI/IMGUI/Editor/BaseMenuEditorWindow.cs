...
namespace CZToolKitEditor
{
    ...
    public abstract class BaseMenuEditorWindow : EditorWindow
    {
        ...
        {
            leftArea.rect = new Rect(0, 0, 150, 150);
        ...
        protected virtual void OnGUI()
        {
            ...
            {
                center = tempCenter;
                leftArea.rect.x = center.x;
                leftArea.rect.y = center.y;
                leftArea.rect.height = center.height;
            ...
            // 左列表
            using (new GUILayout.AreaScope(leftArea.rect))
            {
                GUILayout.Space(3);
                OnLeftGUI();
            }
            ...
            sideRect.xMin = leftArea.rect.xMax;
            sideRect.width = 1;
