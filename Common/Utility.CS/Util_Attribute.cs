...
namespace CZToolKit.Common
{
    public static partial class Util_Attribute
    {
        ...
        public static bool TryGetFieldAttribute<AttributeType>(Type type, string fieldName,
            ...
            where AttributeType : Attribute
        {
            return TryGetFieldAttribute(Util_Reflection.GetField(type, fieldName), out attribute);
        }
        ...
        {
            return GetFieldAttributes(Util_Reflection.GetField(type, fieldName));
        }
        ...
        public static bool TryGetMethodAttribute<AttributeType>(Type type, string _methodName,
            ...
            where AttributeType : Attribute
        {
            return TryGetMethodAttribute(Util_Reflection.GetMethod(type, _methodName), out _attribute);
        }
        ...
        {
            return GetMethodAttributes(Util_Reflection.GetMethod(type, _methodName));
        }
