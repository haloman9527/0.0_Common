...
namespace CZToolKit.Common
{
    ...
    public class Snowflake
    {
        ...
        public Snowflake(byte workerID, byte datacenterID) : this(workerID, datacenterID, DEFAULT_BASE_TIMESTAMP)
        {
        ...
        public Snowflake(byte workerID, byte datacenterID, long baseTimestamp)
        {
