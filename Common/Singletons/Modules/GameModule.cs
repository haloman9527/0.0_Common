...
namespace CZToolKit
{
    public class GameModule
    {
        ...
        public class SubModulesQueueCachePool : ObjectPool<Queue<GameModule>>
        {
            ...
            protected override void OnAcquire(Queue<GameModule> unit)
            {
                base.OnAcquire(unit);
                unit.Clear();
            }

            protected override void OnRelease(Queue<GameModule> unit)
            {
                base.OnRelease(unit);
                unit.Clear();
            }
        ...
        public class SubModulesStackCachePool : ObjectPool<Stack<GameModule>>
        {
            ...
            protected override void OnAcquire(Stack<GameModule> unit)
            {
                base.OnAcquire(unit);
                unit.Clear();
            }

            protected override void OnRelease(Stack<GameModule> unit)
            {
                base.OnRelease(unit);
                unit.Clear();
            }
